...
This version (0.0.11) is designed for OpenNMS versions 33.x (tested with 33.1.8)

0.0.10 tested with OpenNMS 33.x 

0.0.9 tested with OpenNMS 32.x 
...
# fetch the opennms code associated with the plugin (--progress shows you what is happening with a slow download)
...
```
    <org.opennms.version>33.0.1</org.opennms.version>
```
