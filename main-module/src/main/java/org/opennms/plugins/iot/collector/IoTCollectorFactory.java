...
public class IoTCollectorFactory implements ServiceCollectorFactory<IoTCollector> {
    ...
    public String getCollectorClassName() {
    	LOG.debug("getCollectorClassName called : IotCollector.");
        return IoTCollector.class.getCanonicalName();
    }
    ...
    public Map<String, Object> unmarshalParameters(Map<String, String> map) {
        ...
        map.forEach((key, value) -> {
            if (IoTCollector.MAGIC_NUMBER_PARM.equals(key)) {
                try {
